...
export const ORGANS = Object.freeze([
  ...
  { id: "loops/family", module: "packages/engine/loops/family.js", fn: "crossFamilyLevel", op: "EVA", grain: "Pattern", verb: "evaluate", what: "cross-family level stability; a bad perturbation fails globally" },
  ...
  { id: "emergence/voice", module: "packages/engine/emergence/voice.js", fn: "enterVoice", op: "DEF", grain: "Figure", verb: "refuse", what: "who is speaking, or being cited; outside every asserted voice, a typed gap" },
  ...
  { id: "perceiver/text/relations", module: "packages/engine/perceiver/text/relations.js", fn: "extractRelations", op: "CON", grain: "Figure", verb: "bind", what: "subject · verb · object triples; the graph's medium-specific mouth" },
  ...
  { id: "referents/entity/sense", module: "packages/engine/referents/entity.js", fn: "senseEntity", op: "SIG", grain: "Figure", verb: "scout", what: "is this being here, and is its ground fit to see against — ananda is the warmth you check for, never a gate" },
  ...
  { id: "referents/entity/carry", module: "packages/engine/referents/entity.js", fn: "carryEntities", op: "REC", grain: "Figure", verb: "rezero", what: "the register the next turn receives, in birth order — never ranked by count or by ananda" },
